...
export interface paths {
    ...
    "/api/auto-labeling/providers": {
        ...
        /**
         * Get Providers
         * @description Get all available auto-labeling providers.
         *
         *     Returns:
    ...
    "/api/auto-labeling/providers/{provider_id}/parameters": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
         ...
         * @description Get parameters for a specific provider.
         *
         *     Args:
         ...
         */
        get: operations["get_provider_parameters"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/auto-labeling/collections/{collection_id}/jobs": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /**
         * List Jobs
         * @description List auto-labeling jobs for a collection.
         *
         *     Args:
         ...
         * @description Start a new auto-labeling job.
         *
         *     Args:
         ...
         *         HTTPException: If provider is not found.
         */
        post: operations["start_auto_labeling_job"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/auto-labeling/jobs/{job_id}": {
        ...
        /**
         * Get Job Status
         * @description Get status of an auto-labeling job.
         *
         *     Args:
...
export interface components {
    schemas: {
         ...
         * @description Status of an auto-labeling job.
         * @enum {string}
         */
        AutoLabelingJobStatus: "pending" | "running" | "completed" | "failed" | "cancelled";
        /**
         * AutoLabelingJobView
         * @description Model for viewing an auto-labeling job.
         */
        AutoLabelingJobView: {
            /**
             * Job Id
            ...
            /** Provider Id */
            provider_id: string;
            status: components["schemas"]["AutoLabelingJobStatus"];
            /** Processed Count */
        ...
        /**
         * StartJobRequest
         * @description Request body for starting an auto-labeling job.
         */
        StartJobRequest: {
            /** Provider Id */
            provider_id: string;
    ...
    get_provider_parameters: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["ProviderParameter"][];
                };
            };
            /** @description Validation Error */
            422: {
    ...
    list_jobs: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["AutoLabelingJobView"][];
                };
            };
            /** @description Validation Error */
            422: {
