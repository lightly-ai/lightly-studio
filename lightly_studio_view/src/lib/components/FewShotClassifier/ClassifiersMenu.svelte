                                ...
                                {#if $classifiersSelected.size > 0}
                                    <div class="rounded-lg bg-muted/50 p-4">
                                        <div class="flex items-start gap-2">
                                            ...
                                            <Tooltip
                                                content="The results will be added as new annotations to the collection. New annotation classes with the format 'classifier_class_name' will be created for each class of the classifier after a successful run."
                                            >
