...
describe('GroupItem', () => {
    it('renders image when group_preview is an image', () => {
    ...
    it('renders video player when group_preview is a video', () => {
        const group = createMockGroup({
            group_preview: {
                type: 'video',
                sample_id: 'video-123',
    ...
    it('renders "No preview" fallback when group_preview is null', () => {
        const group = createMockGroup({
            group_preview: null
        });
