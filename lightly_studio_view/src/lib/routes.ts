...
export const isPointCloudsRoute = (routeId: string | null): boolean => {
    return routeId ? routeId == APP_ROUTES.pointClouds : false;
};

export const isPointCloudLabelingRoute = (routeId: string | null): boolean => {
    return routeId ? routeId == APP_ROUTES.pointCloudLabeling : false;
};
...
export const routeHelpers = {
    ...
    toPointCloudLabeling: (params: PointCloudLabelingDetailsParams) => {
        return routes.collection.pointCloudLabeling(params);
    },
    toGroupDetails: (
        datasetId: string,
        collectionType: string,
