...
export const APP_ROUTES: Record<string, LayoutRouteId> = {
    evaluations: '/datasets/[dataset_id]/evaluations',
...
export const isEvaluationsRoute = (routeId: string | null): boolean => {
    return routeId ? routeId == APP_ROUTES.evaluations : false;
};
...
export const routes = {
    ...
    collection: {
        evaluations: (datasetId: string) => `/datasets/${datasetId}/evaluations`,
...
export const routeHelpers = {
    toHome: () => routes.home(),
    toEvaluations: (datasetId: string) => routes.collection.evaluations(datasetId),
