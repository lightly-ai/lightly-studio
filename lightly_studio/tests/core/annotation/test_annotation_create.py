...
def test_create_instance_segmentation_from_binary_mask() -> None:
    # Create a simple binary mask (10x10) with a 3x2 square in the middle.
    # The square is at rows 2, 3 and 4 and columns 3 and 4 (numbered from 0).
    ...
    # 2 ones in row 3.
    # 5 zeros in row 3 + 4 zeros in row 3 = 8 zeros.
    # 2 ones in row 4.
    # 5 zeros in row 4 + 5 rows of 10 zeros (50) = 55 zeros.
    assert result.segmentation_mask == [23, 2, 8, 2, 8, 2, 55]


def test_create_semantic_segmentation_from_binary_mask() -> None:
    # Create a simple binary mask (10x10) with a 2x2 square in the middle.
