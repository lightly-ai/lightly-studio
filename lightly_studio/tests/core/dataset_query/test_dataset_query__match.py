...
class TestDatasetQueryMatch:
    def test_match__width_less_than(self, db_session: Session) -> None:
    ...
    def test_match__file_name_equals(self, db_session: Session) -> None:
    ...
    def test_match__created_at_newer(self, db_session: Session) -> None:
    ...
    def test_match__boolean_combo_flat(self, db_session: Session) -> None:
    ...
    def test_match__boolean_combo_nested(self, db_session: Session) -> None:
    ...
    def test_match__multiple_calls_raises_error(self, db_session: Session) -> None:
    ...
    def test_match__tags_contains(self, db_session: Session) -> None:
        ...
        # Assign tags
        tag_resolver.add_tag_to_sample(session=db_session, tag_id=dog_tag.tag_id, sample=image2.sample)
        tag_resolver.add_tag_to_sample(session=db_session, tag_id=dog_tag.tag_id, sample=image3.sample)
        tag_resolver.add_tag_to_sample(session=db_session, tag_id=cat_tag.tag_id, sample=image3.sample)
