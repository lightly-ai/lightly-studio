...
class TestDatasetQuerySlice:
    def test_slice__basic_parameters(self, db_session: Session) -> None:
    ...
    def test_slice__limit_only(self, db_session: Session) -> None:
    ...
    def test_slice__offset_only(self, db_session: Session) -> None:
    ...
    def test_slice__multiple_calls_raises_error(self, db_session: Session) -> None:
    ...
    def test__getitem____slice_variations(self, db_session: Session) -> None:
    ...
    def test__getitem____returns_self_for_chaining(self, db_session: Session) -> None:
    ...
    def test__getitem____integer_indexing_raises_error(self, db_session: Session) -> None:
    ...
    def test__getitem____slice_with_step_raises_error(self, db_session: Session) -> None:
    ...
    def test__getitem____negative_indices_raises_error(self, db_session: Session) -> None:
    ...
    def test__getitem____after_slice_raises_error(self, db_session: Session) -> None:
    ...
    def test_slice__after_getitem_raises_error(self, db_session: Session) -> None:
