...
def test_update_annotation_segmentation_mask(
    ...
    updated_annotation = annotations_service.update_annotation(
        db_session,
        AnnotationUpdate(
            collection_id=segmentaton_mask_annotation.sample.collection_id,
