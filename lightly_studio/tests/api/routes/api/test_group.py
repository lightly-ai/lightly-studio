...
def test_get_all_groups(test_client: TestClient, db_session: Session) -> None:
    ...
    response = test_client.post(
        f"/api/collections/{group_col.collection_id}/group/",
        params={
            "offset": 0,
            "limit": 10,
        },
...
def test_get_all_groups__with_filter(test_client: TestClient, db_session: Session) -> None:
    ...
    # Act - Filter by specific sample_ids
    response = test_client.post(
        f"/api/collections/{group_col.collection_id}/group/",
        params={
            "offset": 0,
