...
from tests.resolvers.video_resolver.helpers import VideoFixture, create_videos


class TestGetAllByDatasetId:
    def test_get_all_by_dataset_id(self, test_db: Session) -> None:
        ...
        create_videos(
            ...
            videos=[
                VideoFixture(file_path_abs="/path/to/sample2.mp4"),
                VideoFixture(file_path_abs="/path/to/sample1.mp4"),
            ],
        )
    ...
    def test_get_all_by_dataset_id__with_pagination(
        ...
        video_ids = create_videos(
            session=test_db,
            dataset_id=dataset_id,
            videos=[VideoFixture(file_path_abs=f"/sample{i}.mp4") for i in range(5)],
        )
    ...
    def test_get_all_by_dataset_id__with_sample_ids(
        ...
        video_ids = create_videos(
            ...
            videos=[
                VideoFixture(file_path_abs="/path/to/sample1.mp4"),
                VideoFixture(file_path_abs="/path/to/sample2.mp4"),
                VideoFixture(file_path_abs="/path/to/sample3.mp4"),
            ],
        )
