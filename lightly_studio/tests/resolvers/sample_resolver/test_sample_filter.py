...
class TestSampleFilter:
    ...
    def test_apply__annotation_filter(self, test_db: Session) -> None:
        ...
        # Create annotations
        cat_label = create_annotation_label(session=test_db, root_dataset_id=dataset_id, label_name="cat")
        dog_label = create_annotation_label(session=test_db, root_dataset_id=dataset_id, label_name="dog")
