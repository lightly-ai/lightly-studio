...
def test_get_all(
    ...
    create_annotation_label(session=db_session, root_dataset_id=collection_id_1, label_name="dog")
    create_annotation_label(session=db_session, root_dataset_id=collection_id_1, label_name="zebra")
    create_annotation_label(session=db_session, root_dataset_id=collection_id_1, label_name="cat")
    collection_id_2 = create_collection(session=db_session, collection_name="ds2").collection_id
    create_annotation_label(session=db_session, root_dataset_id=collection_id_2, label_name="bird")
    labels = annotation_label_resolver.get_all(
        session=db_session,
        root_dataset_id=collection_id_1,
    )
