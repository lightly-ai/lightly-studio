...
def test_remove_annotation_from_object_track(test_db: Session) -> None:
    ...
    linked = object_track_resolver.add_annotation_to_object_track(
        session=test_db,
    ...
    result = object_track_resolver.remove_annotation_from_object_track(
        session=test_db,
