...
def test_delete_track__unlinks_annotations(test_db: Session) -> None:
    ...
    object_track_resolver.delete_track(
        session=test_db,
...
def test_delete_track__not_found(test_db: Session) -> None:
