...
def test_get_adjacent_annotations__respects_annotation_tags(test_db: Session) -> None:
    collection = helpers_resolvers.create_collection(session=test_db, sample_type=SampleType.IMAGE)
    collection_id = collection.collection_id
    ...
    tag_resolver.add_sample_ids_to_tag_id(
        session=test_db, tag_id=tag_one.tag_id, sample_ids=[annotation_a.sample_id]
    )
    tag_resolver.add_sample_ids_to_tag_id(
        session=test_db,
    ...
    tag_resolver.add_sample_ids_to_tag_id(
        session=test_db, tag_id=tag_two.tag_id, sample_ids=[annotation_b.sample_id]
    )
    tag_resolver.add_sample_ids_to_tag_id(
        session=test_db, tag_id=tag_two.tag_id, sample_ids=[annotation_c.sample_id]
    )
...
def test_get_adjacent_annotations__respects_sample_tags(test_db: Session) -> None:
    collection = helpers_resolvers.create_collection(session=test_db, sample_type=SampleType.IMAGE)
    collection_id = collection.collection_id
    ...
    tag_resolver.add_sample_ids_to_tag_id(
        session=test_db, tag_id=sample_tag_one.tag_id, sample_ids=[image_a.sample_id]
    )
    tag_resolver.add_sample_ids_to_tag_id(
        session=test_db,
    ...
    tag_resolver.add_sample_ids_to_tag_id(
        session=test_db, tag_id=sample_tag_two.tag_id, sample_ids=[image_b.sample_id]
    )
    tag_resolver.add_sample_ids_to_tag_id(
        session=test_db, tag_id=sample_tag_two.tag_id, sample_ids=[image_c.sample_id]
    )
