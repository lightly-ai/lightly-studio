...
def test_get_or_create_video_frame_child(
    ...
    assert video_frames_dataset.name == "videos_video_frames"
...
def test_get_or_create_video_frame_child__existing_dataset_child(
    db_session: Session,
) -> None:
    """Test creating a video frame child dataset."""
    # First tree
    ...
    # Ensure that the new dataset is different from the existing child dataset.
