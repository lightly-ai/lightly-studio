...
def test_select_via_database_with_annotation_class_balancing_target(
    ...
    label_cat = create_annotation_label(session=test_db, root_dataset_id=dataset_id, label_name="cat")
    label_dog = create_annotation_label(session=test_db, root_dataset_id=dataset_id, label_name="dog")
    label_bird = create_annotation_label(session=test_db, root_dataset_id=dataset_id, label_name="bird")
...
def test_get_class_balancing_data_target(test_db: Session) -> None:
    ...
    label_cat_obj = create_annotation_label(session=test_db, root_dataset_id=dataset_id, label_name="cat")
    label_dog_obj = create_annotation_label(session=test_db, root_dataset_id=dataset_id, label_name="dog")
