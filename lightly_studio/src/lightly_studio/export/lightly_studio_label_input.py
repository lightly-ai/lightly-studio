...
class LightlyStudioObjectDetectionInput(ObjectDetectionInput):
    ...
    def __init__(self, session: Session, root_dataset_id: UUID, samples: Iterable[ImageSample]) -> None:
        ...
        self._label_id_to_category = _build_label_id_to_category(session=session, root_dataset_id=root_dataset_id)
