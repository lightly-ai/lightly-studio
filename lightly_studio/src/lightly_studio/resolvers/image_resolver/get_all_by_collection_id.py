...
def get_all_by_collection_id(  # noqa: PLR0913
    ...
    if filters is not None and filters.sample_filter is not None:
        filters.sample_filter.resolve_embedding_region(session=session, collection_id=collection_id)
