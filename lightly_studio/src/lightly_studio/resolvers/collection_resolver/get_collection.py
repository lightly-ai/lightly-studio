...
def get_collection(session: Session, collection_id: UUID | None = None) -> CollectionTable:
    ...
    A root collection is defined as a collection where parent_collection_id is None.
