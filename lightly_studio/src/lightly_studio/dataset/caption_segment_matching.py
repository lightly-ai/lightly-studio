...
from lightly_studio.embed.perception_encoder_embedder import PerceptionEncoderEmbedder
...
DEFAULT_MIN_CAPTION_SEGMENT_MATCH_SCORE = 0.35
...
def score_caption_segments(
    ...
    embedding_generator: PerceptionEncoderEmbedder | None = None,
) -> list[float]:
    ...
    generator = embedding_generator or PerceptionEncoderEmbedder()
