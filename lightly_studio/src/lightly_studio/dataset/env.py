...
LIGHTLY_STUDIO_MEDIA_DIRECT_URLS: bool = env.bool("LIGHTLY_STUDIO_MEDIA_DIRECT_URLS", False)
LIGHTLY_STUDIO_MEDIA_DIRECT_URL_TTL_SECONDS: int = max(
    1, env.int("LIGHTLY_STUDIO_MEDIA_DIRECT_URL_TTL_SECONDS", 300)
)
