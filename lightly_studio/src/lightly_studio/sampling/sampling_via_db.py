...
def sampling_via_database(
    ...
    Raises:
        ValueError: If the preselected tag does not exist, if its sample IDs contain
            duplicates or are not a subset of the input sample IDs, or, for sequence
            sampling, if they do not cover whole sequences.
    """
