...
def register_default_embedder(
    ...
    Args:
        ...
        bootstrap_for: Capabilities for which this embedder becomes the default choice.
    ...
    """
    embedder_registry.get_registry().register(embedder=embedder, bootstrap_for=bootstrap_for)
