...
For dataset-type-specific loading examples, see [Image Dataset · From an Existing Dataset](../workflows/image_dataset.md#from-an-existing-dataset) and [Video Dataset · From an Existing Dataset](../workflows/video_dataset.md#from-an-existing-dataset).
