...
For dataset-type-specific loading examples, see [Image Dataset · From an Existing Dataset](../dataset_setup/image_dataset.md#from-an-existing-dataset) and [Video Dataset · From an Existing Dataset](../dataset_setup/video_dataset.md#from-an-existing-dataset).
