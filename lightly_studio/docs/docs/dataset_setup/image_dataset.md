...
Use [Dataset Query in Python](../concepts_and_tools/search_and_filter.md#dataset-query-in-python) when you need reusable subsets in code for filtering, sorting, slicing, export, or selection. Image queries use the `ImageSampleField`.
