...
- [ ] The PR is small enough to review comfortably, or the size is justified
- [ ] The branch is in a valid, working state
- [ ] Relevant tests and checks pass
- [ ] The PR description explains what changed and why
- [ ] Unrelated refactoring, formatting, or cleanup was left out
